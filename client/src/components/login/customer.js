...
import bg from '../../resource/images/login/01.jpg';
import bg_2 from '../../resource/images/login/02.png';
import customer_logo from '../../resource/images/login/03.png';
import user_icon from '../../resource/images/login/04.png';
import password_icon from '../../resource/images/login/05.png';
        ...
        <Box style={{
            ...
            backgroundImage: `url(${bg_2})`}}>
                    <Box component="form" onSubmit={onSubmit} style={{width:490,height:680,marginLeft:610}}>
                        <img src={customer_logo} style={{marginLeft:65,marginTop:140}} />

                        <Box style={{border:'1px solid black',width:400,height:190,marginLeft:40,marginTop:20}}>
                            <Box style={{width:400,height:40,backgroundColor:COLOR.green,borderBottom:'1px solid black'}}>
                            ...
                            <Grid container>
                                    ...
                                    <Grid item={true} xs={10} style={{padding:20}}>
                                        <StandardInput   onChange = {onChange} name='email' placeholder='email' size='small' style={{width:"100%"}}></StandardInput>
                            ...
                            <Grid container style={{marginTop:-20}}>
                                    ...
                                    <Grid item={true} xs={10} style={{padding:20}}>
                                        <StandardInput  onChange = {onChange} name='password' placeholder='password' type="password" size='small' style={{width:"100%"}}></StandardInput>
                           
                                    </Grid>
                            </Grid>
                        </Box>

                        <Typography onClick={handleClickOpen} style={{fontFamily:'kanit-regular',fontSize:14,textAlign:'right',fontStyle:'italic',marginRight:49}}>Forgot Your Password?</Typography>

                        <Button 
                            type="submit"style={{backgroundColor:COLOR.green,fontFamily:'kanit-medium',fontSize:20,borderRadius:20,width:300,color:COLOR.white,marginTop:20,height:40,marginLeft:90}}>Log in</Button>

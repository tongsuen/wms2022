...
const StyledButton = styled('button')(
  ...
  background-color:${COLOR.soft_green};
...
export const CustomMultiSelect = React.forwardRef(function CustomMultiSelect(
  ...
  const components: MultiSelectUnstyledProps<number> = {
    Root: StyledButton,
...
// export default function UnstyledSelectsMultiple({options}) {

  
//   return (
//     <CustomMultiSelect defaultValue={[10, 20]}>
//         {options.map(item => {
//             return <StyledOption value={10}>{item.lot_number}</StyledOption>
//         })}

...
export  const  ReportWarehouse = (data) => (
  <Document>
   <Page style={styles.page} size="A4" wrap>
        ...
        <View style={[styles.row, styles.row]}>
                ...
                <View style={[styles.headerText, styles.cell,{color:'black'}]}>
                    ...
                    <Text style={[styles.text_regular,{textAlign:'center'},styles.size_big]} >รายงานสินค้าคงคลัง</Text>
        ...
        <View style={styles.table}>
            <View style={[styles.row, styles.header,{color:'white',width:"100%"}]}>
                <Text style={[styles.text_regular,styles.headerText, styles.cell,styles.size_small,{width:100}]}>วันที่</Text>
            ...
            {data.list.map((item)=>{
                return  <View style={[styles.row,{}]} wrap={false}>
                            <Text style={[styles.cell,styles.text_regular,styles.size_small,styles.border,{width:50}]}>{moment(item.create_date).format('DD/MM/yyyy')}</Text>
                            <Text style={[styles.cell,styles.text_regular,styles.size_small,styles.border,{width:100}]}>{item.inventory &&item.inventory.lot_number}</Text>
                            <Text style={[styles.cell,styles.text_regular,styles.size_small,styles.border,{width:50}]}>{item.inventory &&item.inventory.product_code}</Text>
                            <Text style={[styles.cell,styles.text_regular,styles.size_small,styles.border,{width:100}]}>{item.inventory &&item.inventory.name}</Text>
                            ...
                            <Text style={[styles.cell,styles.text_regular,styles.size_small,styles.border,{width:50}]}>{item.current_amount}</Text>
                        </View>
            })}
